...
def handle_message(event):
    ...
    if user_input in ["help", "ช่วยเหลือ", "วิธีใช้", "สอบถาม"]:
        reply_text = (
            ...
            "พิมพ์ 'ทำนาย' เพื่อเริ่มต้นการพยากรณ์\n\n"
            "🩺 ตอบค่าต่างๆ ที่บอทถามทีละข้อ เช่น น้ำตาลในเลือด, อินซูลิน ฯลฯ\n\n"
            "✍️ กรอกค่าต่างๆ ตามที่กำหนด (มีตัวอย่างให้ดูนะ!)\n\n"
            "📊 รับผลการพยากรณ์ ทันทีหลังจากกรอกครบ\n\n"
